...
export default function Home(){
    return(
        <div>
            ...
            <p>Existing users: Log in with your username and password using the Login tab at the top of the page.
            <br></br>New users: Use the Register tab to create an account and submit your information.</p>
        </div>
    );
}